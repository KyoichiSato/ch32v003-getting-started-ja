...
レジスタ数が多めだけど、1つのレジスタに 1つの機能なのでわかりやすい。
```
```
...
リセット後初期値はフローティング入力
プルアップ/プルダウン入力設定時は、OUTDRでプルアップ/ダウンを選択
...
[31: 8]          RO Reserved
[ 7: 0] ODR[7:0] RW 出力設定時 ポートの出力データ
                    プルアップ/ダウン入力設定時 各ビットのプルアップ/プルダウン選択
                    0:プルダウン 1:プルアップ
